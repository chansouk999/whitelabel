...
<body class="white-content">
    <div id="app">
        ...
        phoneverification="@lang('home.phoneverification')"
        mytask="@lang('home.mytask')"
        recommendfriends="@lang('home.recommendfriends')"
        bankinfo="@lang('home.bankinfo')"
        transactionrecord="@lang('home.transactionrecord')"
        accountsettings="@lang('home.accountsettings')"
        unverified="@lang('home.unverified')"
        totalbalance="@lang('home.totalbalance')"
        yuan="@lang('home.yuan')"
        gamebalance="@lang('home.gamebalance')"
        localbalance="@lang('home.localbalance')"
        fastrecharge="@lang('home.fastrecharge')"
        applyforwithdrawal="@lang('home.applyforwithdrawal')"
        selfservicerolling="@lang('home.selfservicerolling')"
        home="@lang('home.home')"
