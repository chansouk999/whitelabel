...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('')}}assetspromote/assetspromote/img/apple-icon.png">
    <link rel="icon" type="image/png" href="assetspromote/assetspromote/img/favicon.png">
    <title>Whitlabel</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link href="{{asset('assetspromote/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('assetspromote/css/mdb.min.css')}}" rel="stylesheet">
    <link href="{{asset('assetspromote/styles/main.css')}}" rel="stylesheet">
</head>
...
<body id="top">
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" id="navbar">
            <div class="container"><a class="navbar-brand" href="{{url('/')}}"><strong>Whitlabel</strong></a>
        ...
        <section class="py-5" id="projects">
            <div class="container">
                ...
                <div class="row wow fadeInLeft" data-wow-delay=".3s">
                    <div class="col-lg-6 col-xl-5 pr-lg-5 pb-5"><img class="img-fluid rounded z-depth-2" src="/assetspromote/img/kuala-lumpur.jpg" alt="project image" /></div>
                ...
                <div class="row pt-5 wow fadeInRight" data-wow-delay=".3s">
                    ...
                    <div class="col-lg-6 col-xl-5 mb-3"><img class="img-fluid rounded z-depth-2" src="assetspromote/img/san-francisco.jpg" alt="project image" /></div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row mb-lg-4 center-on-small-only">
                    <div class="col-lg-6 col-md-12 mb-r wow fadeInLeft" data-wow-delay=".3s">
                        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="assetspromote/img/woman-1.jpg" alt="team member" /></div>
                    ...
                    <div class="col-lg-6 col-md-12 mb-r wow fadeInRight" data-wow-delay=".3s">
                        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="assetspromote/img/woman-2.jpg" alt="team member" /></div>
                        <div class="col-md-6 float-right">
                ...
                <div class="row center-on-small-only">
                    <div class="col-lg-6 col-md-12 mb-r wow fadeInLeft" data-wow-delay=".3s">
                        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="assetspromote/img/man-1.jpg" alt="team member" /></div>
                        <div class="col-md-6 float-right">
                    ...
                    <div class="col-lg-6 col-md-12 mb-r wow fadeInRight" data-wow-delay=".3s">
                        <div class="col-md-6 float-left"><img class="img-fluid rounded z-depth-1 mb-3" src="assetspromote/img/man-2.jpg" alt="team member" /></div>
                        <div class="col-md-6 float-right">
    ...
    <footer class="page-footer indigo darken-2 center-on-small-only pt-0 mt-0">
        ...
        <!--   Core JS Files   -->
        <script type="text/javascript" src="{{asset('assetspromote/js/jquery-3.2.1.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('assetspromote/js/popper.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('assetspromote/js/bootstrap.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('assetspromote/js/mdb.min.js')}}"></script>
        <script>
            new WOW().init();
        </script>
