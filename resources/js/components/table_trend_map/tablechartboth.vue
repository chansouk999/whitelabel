...
export default {
  ...
  watch: {
    ...
    tbdatachart() {
      ...
      this.number =
        parseInt(this.tbdatachart[this.tbdatachart.length - 2]) +
        parseInt(this.tbdatachart[this.tbdatachart.length - 1]);
            ...
            for (let i = 0; i < this.rowTable; i++) {
              ...
              for (let j = 0; j < 300; j++) {
                if (
                  ...
                  countBig++;
                  $(".countBigBoth").text(this.b + " = " + countBig);
                  this.$refs.tablebsTwo.children[i].children[j].textContent =
                    "";
                  ...
                  countSmall++;
                  $(".countSmallBoth").text(this.s + " = " + countSmall);
                  this.$refs.tablebsTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebsTwo.children[i].children[j].classList.add(
                    "rs0"
            ...
            for (let i = 0; i < this.rowTable; i++) {
              ...
              for (let j = 0; j < 200; j++) {
                if (
                  ...
                  countOdd++;
                  $(".countOddBoth").text(this.o + " = " + countOdd);
                  this.$refs.tableOETwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tableOETwo.children[i].children[j].classList.add(
                    "rs-o"
                  ...
                  countEven++;
                  $(".countEvenBoth").text(this.e + " = " + countEven);
                  this.$refs.tableOETwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tableOETwo.children[i].children[j].classList.add(
                    "rs-e"
            ...
            for (let i = 0; i < this.rowTable; i++) {
              for (let j = 0; j < 900; j++) {
                if (
                  ...
                  countUpper++;
                  $(".countUpperBoth").text(this.u + " = " + countUpper);
                  this.$refs.tablebUMLTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebUMLTwo.children[i].children[j].classList.add(
                    "rs-u"
                  ...
                  countMiddle++;
                  $(".countMiddleBoth").text(this.m + " = " + countMiddle);
                  this.$refs.tablebUMLTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebUMLTwo.children[i].children[j].classList.add(
                    "rs-m"
                  ...
                  countLower++;
                  $(".countLowerBoth").text(this.l + " = " + countLower);
                  this.$refs.tablebUMLTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebUMLTwo.children[i].children[j].classList.add(
                    "rs-l"
