  ...
  <div>
    <div class="row mobile-modern">
      <div class="col-12 col-md-12 col-lg-6 col-sm-12 full-screen col-mobile" v-show="which_one=='B/S' || which_one==true ">
        <div v-show="isFullScreen">
          <span class="countBigLast text-white"></span>
          <span class="countSmallLast text-white"></span>
        </div>
      ...
      <div class="col-12 col-md-12 col-lg-6 col-sm-12 full-screen col-mobile" v-show="which_one=='O/E' || which_one==true ">
        <div v-show="isFullScreen">
          <span class="countOddLast text-white"></span>
          <span class="countEvenLast text-white"></span>
        </div>
        <div class="my-coltabledivlast">
    ...
    <div class="row mobile-modern">
      <div class="col-12 col-md-12 col-lg-6 col-sm-12 full-screen col-mobile" v-show="which_one=='U/L' || which_one==true ">
        <div v-show="isFullScreen">
          <span class="countUpperLast text-white"></span>
          <span class="countMiddleLast text-white"></span>
          <span class="countLowerLast text-white"></span>
        </div>
...
export default {
  ...
  watch: {
    ...
    tbdatachart() {
      ...
      this.number = this.tbdatachart[this.tbdatachart.length - 1];
            ...
            for (let i = 0; i < this.rowTable; i++) {
              ...
              for (let j = 0; j < 300; j++) {
                if (
                  ...
                  countBig++;
                  $(".countBigLast").text(this.b + " = " + countBig);
                  this.$refs.tablebsTwo.children[i].children[j].textContent =
                    "";
                  ...
                  countSmall++;
                  $(".countSmallLast").text(this.s + " = " + countSmall);
                  this.$refs.tablebsTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebsTwo.children[i].children[j].classList.add(
                    "rs0"
            ...
            for (let i = 0; i < this.rowTable; i++) {
              ...
              for (let j = 0; j < 200; j++) {
                if (
                  ...
                  countOdd++;
                  $(".countOddLast").text(this.o + " = " + countOdd);
                  this.$refs.tableOETwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tableOETwo.children[i].children[j].classList.add(
                    "rs-o"
                  ...
                  countEven++;
                  $(".countEvenLast").text(this.e + " = " + countEven);
                  this.$refs.tableOETwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tableOETwo.children[i].children[j].classList.add(
                    "rs-e"
            ...
            for (let i = 0; i < this.rowTable; i++) {
              for (let j = 0; j < 900; j++) {
                if (
                  ...
                  countUpper++;
                  $(".countUpperLast").text(this.u + " = " + countUpper);
                  this.$refs.tablebUMLTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebUMLTwo.children[i].children[j].classList.add(
                    "rs-u"
                  ...
                  countMiddle++;
                  $(".countMiddleLast").text(this.m + " = " + countMiddle);
                  this.$refs.tablebUMLTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebUMLTwo.children[i].children[j].classList.add(
                    "rs-m"
                  ...
                  countLower++;
                  $(".countLowerLast").text(this.l + " = " + countLower);
                  this.$refs.tablebUMLTwo.children[i].children[j].textContent =
                    "";
                  this.$refs.tablebUMLTwo.children[i].children[j].classList.add(
                    "rs-l"
