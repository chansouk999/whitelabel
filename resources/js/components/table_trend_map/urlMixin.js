    ...
    methods: {
        setUrlMixin(s, l = 5) {
            if (s == "SH000001") {
                ...
                if (l == 5) {
                    this.urlCrawl = "http://159.138.45.25/api/btc";
                } else if (l == 1) {
                    this.urlCrawl = "http://159.138.45.25/api/btc1";
                } else {
                    alert("it will be redirect to 404 page")
                }
            } else if ("US dollar Index") {
                this.urlCrawl = "http://159.138.45.25/api/usindex";
